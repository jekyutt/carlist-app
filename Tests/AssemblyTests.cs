...
namespace SemestriProject.Tests
{
    public class AssemblyTests
    {
        ...
        private static string testAssembly => "SemestriProject.Tests";
        private static string assembly => "SemestriProject";
        ...
        private static void report(string messege, params object[] parameters)
        {
            Assert.Fail(messege, parameters);
        }
